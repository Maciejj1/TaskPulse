...
class _$WeatherResponseImpl extends _WeatherResponse {
  const _$WeatherResponseImpl(
      {this.name, this.main, final List<Weather>? weather})
      : _weather = weather,
        super._();
  ...
  @override
  String toString() {
    return 'WeatherResponse(name: $name, main: $main, weather: $weather)';
  }
...
abstract class _WeatherResponse extends WeatherResponse {
  const factory _WeatherResponse(
      {final String? name,
      final Main? main,
      final List<Weather>? weather}) = _$WeatherResponseImpl;
