...
class DashboardScreenTasksHighPriorityAnalitycs extends StatelessWidget {
  const DashboardScreenTasksHighPriorityAnalitycs({
    super.key,
  });
        ...
        child: Column(
          children: [
            BlocBuilder<DashboardCubit, DashboardState>(
              bloc: context.read<DashboardCubit>()..getHighPriorityTasks(),
